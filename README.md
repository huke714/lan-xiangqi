...
**仓库：** [huke714/lan-xiangqi](https://github.com/huke714/lan-xiangqi) · **版本：** [v1.0.0](https://github.com/huke714/lan-xiangqi/releases/tag/v1.0.0)
...
打开 [Releases](https://github.com/huke714/lan-xiangqi/releases/latest)：

| 产物 | 链接 |
|------|------|
| Windows 单文件版（exe） | [yilin-xiangqi-v1.0.0-win-x64.exe](https://github.com/huke714/lan-xiangqi/releases/download/v1.0.0/yilin-xiangqi-v1.0.0-win-x64.exe) |
| 源码包 | [lan-xiangqi-1.0.0-source.zip](https://github.com/huke714/lan-xiangqi/releases/download/v1.0.0/lan-xiangqi-1.0.0-source.zip) |

exe 双击即可运行；源码包解压后按下方启动。
...
|----|----|
| 当前版本 | **v1.0.0** |
| 发行页 | https://github.com/huke714/lan-xiangqi/releases/tag/v1.0.0 |
| Windows 单文件版 | [yilin-xiangqi-v1.0.0-win-x64.exe](https://github.com/huke714/lan-xiangqi/releases/download/v1.0.0/yilin-xiangqi-v1.0.0-win-x64.exe) |
| 源码包 | [lan-xiangqi-1.0.0-source.zip](https://github.com/huke714/lan-xiangqi/releases/download/v1.0.0/lan-xiangqi-1.0.0-source.zip) |
